...
import 'package:kino_app/widgets/movie_details/movie_radial_percent_widget.dart';
    ...
    return Stack(
      children: [
        ...
        Positioned(
          ...
          left: 20,
          bottom: 20,
          child: Image(image: AssetImage(AppImages.topHederSubImage)),
        ),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    return ColoredBox(
      ...
      child: Padding(
        ...
        child: Text(
          'R 04/29/2021 (US) 1h49m Action, Adveture, Thriller, War',
          maxLines: 3,
          textAlign: TextAlign.center,
          style: TextStyle(
              color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400),
...
class _PeopleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final jobTilteeStyle = TextStyle(
      color: Colors.white,
      fontSize: 16,
      fontWeight: FontWeight.w400,
    );
